...
export default function MasterPlanMap({ siteOptions }: { siteOptions: SiteOptions }) {
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        <SectionHeading title="Faisal Hills Master Plan Map" center />
        <p className="mt-4 text-ink/70">
          Explore the officially approved layout of Faisal Hills. Inspect plot dimensions, road networks, sector
          avenues, and central commercial boulevards.
        </p>
      </div>
      ...
      <div className="relative mx-auto mt-10 aspect-video max-w-4xl overflow-hidden rounded-2xl border border-black/10 bg-cream">
        {siteOptions.masterPlanImage ? (
          <Image src={siteOptions.masterPlanImage} alt="Faisal Hills Master Plan" fill className="object-cover" />
        ) : (
